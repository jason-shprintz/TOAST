  ...
  if (!category) {
    return (
      <ScreenBody>
        ...
        <Text style={[styles.errorText, { color: COLORS.PRIMARY_DARK }]}>Category not found</Text>
      </ScreenBody>
    );
  }
            ...
            {category.units.map((unit, index) => (
              <TouchableOpacity
                ...
                style={[
                  styles.unitButton,
                  {
                    backgroundColor: selectedUnitIndex === index ? COLORS.ACCENT : COLORS.TOAST_BROWN,
                    borderColor: COLORS.SECONDARY_ACCENT,
                  },
                ]}
                onPress={() => {
              ...
              >
                <Text
                  style={[
                    ...
                    {
                      color: selectedUnitIndex === index ? COLORS.PRIMARY_LIGHT : COLORS.PRIMARY_DARK,
                    },
                  ]}
                >
                  {unit.name}
        ...
        <View style={styles.keypad}>
          ...
          <View style={styles.keypadRow}>
            <TouchableOpacity
              ...
              onPress={handleClear}
            >
              <Text style={[styles.clearButtonText, { color: COLORS.PRIMARY_LIGHT }]}>Clear</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.keypadButton,
